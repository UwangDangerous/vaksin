<?php 
    ...
    class Petugas_model extends CI_Model{
        ...
        {
            $this->db->where('idBatch', $id);
            $this->db->join('_jenisDokumen', '_jenisDokumen.idJenisDokumen = verifikasi_berkas.idJenisDokumen') ;
            $this->db->select('namaJenisDokumen, verifikasi_berkas.idJenisDokumen as idJenisDokumen');
            return $this->db->get('verifikasi_berkas')->row_array();
        }//new
    }
