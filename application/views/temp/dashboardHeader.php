...
<?php elseif($lvl == 3) : ?> <!-- Verifikator dan Evaluator -->
                            ...
                            <!-- evaluator -->
                                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#evaluator" aria-expanded="false">
                                    <div class="sb-nav-link-icon"><i class="fas fa-user-tie"></i></div>
                                    Evaluator
                                    <div class="sb-sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div>
                                </a>
                                <div class="collapse" id="evaluator" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                                    <nav class="sb-sidenav-menu-nested nav">
                                        <a class="nav-link" href="<?= base_url(); ?>__evaluasi">
                                            <div class="sb-nav-link-icon"><i class="fas fa-edit"></i></div>
                                            Pelulusan Dokumen
